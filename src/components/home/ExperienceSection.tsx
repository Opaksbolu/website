        ...
        <header className="text-center space-y-1">
          <h2 className="relative inline-block text-xs font-black uppercase tracking-[0.5em] text-accent">
            <span
              ...
              "
            >
            {/* 1 - HEADER TITLE TEXT - "Experience" */}
              Experience
            </span>
          ...
          <h3 className="text-5xl md:text-6xl font-black tracking-tighter italic leading-[1.05]">
            <span className="inline-grid overflow-visible">
              <span
                ...
                "
              >
                {/* 2a - HEADER TITLE TEXT - Outline/Bottom Layer - "Technical Stack" */}
                Technical Stack
              </span>
              <span
                className="
                ...
                "
              >
                {/* 2b - HEADER TITLE TEXT - Fill/Top Layer - "Technical Stack" */}
                Technical Stack
              </span>
            </span>
          </h3>
